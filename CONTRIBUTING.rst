...
Report bugs at https://github.com/mikeweltevrede/contribute-to-open-source/issues
...
https://github.com/mikeweltevrede/contribute-to-open-source/issues.
...
Ready to contribute? Here's how to set up `contribute-to-open-source` for local
development. Please note this documentation assumes you already have
`PDM` and `Git` installed and ready to go.

| 1. Fork the `contribute-to-open-source` repo on GitHub.
